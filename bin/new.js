...
console.log('');
console.log('  LOOK AT THE HERO PHOTO before you send this. Stock images are caught by');
console.log('  filename and host, which misses the ones a WordPress theme ships — those');
console.log('  are named banner.jpg and look like a photo of a job until you open them.');
console.log('  Two of the first four prospects turned out to have no photos of their own');
console.log('  work at all, and only looking found it.');
