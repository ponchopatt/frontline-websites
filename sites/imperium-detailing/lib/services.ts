...
export const services: Service[] = [
  {
    ...
    why: [
      ...
      "The coating itself is a liquid-applied SiO2 (silica) resin. Once cured it forms a hard, hydrophobic layer chemically bonded to the paint. Water beads tightly and rolls off, dust doesn't cling, and contaminants like bird droppings, sap and bug remains sit on top of the coating instead of etching into the paint.",
    ...
    included: [
      ...
      "Multi-layer SiO2 ceramic coating",
  ...
  },
  {
    ...
    why: [
      ...
      "The car is dried with plush microfibres and a filtered air blower, then we apply a spray-on SiO2 coating or a paint sealant depending on how long you want protection to last. Tyres get a satin dressing. Glass gets polished and sealed.",
    ],
    included: [
      ...
      "Spray-on SiO2 coating or paint sealant",
