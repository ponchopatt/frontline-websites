...
const CREDENTIALS = [
  ...
  [/\bfree\s+(?:quotes?|consultations?|measures?|inspections?|site visits?|design|advice|call-?outs?)\b|\bno charge\b|\bcosts nothing\b|\bat no cost\b|\b(?:the|your|a)\s+first\s+\w+(?:\s+\w+)?\s+(?:is|are)\s+free\b|\bobligation[- ]free\b/i, /\bfree\b|no charge|no cost|obligation/, 'a free service'],
